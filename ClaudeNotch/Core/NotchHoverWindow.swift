...
enum PanelPage: String, CaseIterable, Hashable {
    case stats, analytics, focus, system, notes, about, settings
...
final class NotchHoverWindow: NSObject, ObservableObject {
    ...
    @Published var activePage: PanelPage = .stats
    ...
    init(manager: ClaudeUsageManager, settings: ClaudeStatsSettings, screen: NSScreen) {
        ...
        NotificationCenter.default.addObserver(
            ...
            name: .openClaudeNotchSettings, object: nil)
    }
...
struct NotchRootView: View {
    ...
    // Content pages shown as equal-width tabs; settings gets a separated gear at the end
    private static let tabBarPages: [PanelPage] = [.stats, .analytics, .focus, .system, .notes, .about]
    ...
    private func submitFeedback() {
        ...
        **Feedback**
        ...
        ---
        *Claude Notch v\(version) (\(build)) · macOS \(os)*
        """
