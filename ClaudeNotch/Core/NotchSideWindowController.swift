...
struct NotchBarRootView: View {
    ...
    private func openSettings() {
        ...
        NotificationCenter.default.post(name: .openClaudeNotchSettings, object: nil)
    }
}
...
extension Notification.Name {
    static let openClaudeNotchSettings = Notification.Name("openClaudeNotchSettings")
}
