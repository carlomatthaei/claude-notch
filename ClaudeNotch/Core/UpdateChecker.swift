...
final class UpdateChecker: ObservableObject {
    ...
    static let repoOwner = "carlomatthaei"
    static let repoName  = "claude-notch"
    ...
    private func showUpdateAlert(newVersion: String, notes: String?) {
        ...
        alert.informativeText = "Claude Notch \(newVersion) is available (you have \(currentVersion)).\(notes.map { "\n\n\($0.prefix(300))" } ?? "")"
